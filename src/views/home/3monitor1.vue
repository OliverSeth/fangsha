      ...
      <div class="deviceInfo1">
        <table>
          <tr class="contentInfoss">
            <th class="titles">卷绕机L8#03<br/>基础信息</th>   <!--标题换行-->
          </tr>
          <tr class="contentInfoss">
            <td>纺丝产线</td>
            <td>纺丝位号</td>
    ...
    <div class="centerBar">
      ...
      <div class="footerInfo"><!--
        ...
        <div class="topBar topBar3" >
          ...
          <div class="btns" @click="Switch1()">卡头</div>
          <div class="btns" @click="Switch2()">摩擦辊</div>
          <div class="btns" @click="Switch3()">横动</div>
          <div class="btns" @click="Switch4()">电机</div>
        </div>
        <div class="deviceInfo1">
          <table>
            <tr class="contentInfoss">
            ...
            <tr class="contentInfoss" v-for="x in datas1" :key="x.id">
              <td>{{x.name1}}</td>
              <td style="border: whitesmoke">{{x.name1Value}}</td>
              <td>{{x.name2}}</td>
              <td style="border: whitesmoke">{{x.name2Value}}</td>
            </tr>
          </table>
        </div>
      </div>
