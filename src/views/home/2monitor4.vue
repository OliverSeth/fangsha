      ...
      <div class="deviceInfo1">
        <table>
          <tr class="contentInfoss">
            <th class="titles">卷绕机L8#02<br/>基础信息-电机</th>   <!--标题换行-->
          </tr>
          <tr class="contentInfoss">
            <td>纺丝产线</td>
            <td>纺丝位号</td>
    ...
    <div class="centerBar">
      <div class="headerInfo">
        <div class="titleIcon">
          ...
          <div @click="Switch240()">设备的选择</div>
        </div>
        <div class="titles">Map OverView</div>
        <div>实时动态</div>
      </div>
      <div class="deviceImg">
        <img src="../../assets/img/dianji2_done.jpg" alt="设备">
      </div>
      <div class="footerInfo"><!--
        ...
        <div class="topBar topBar3" >
          ...
          <div class="btns" @click="Switch241()">卡头</div>
          <div class="btns" @click="Switch242()">摩擦辊</div>
          <div class="btns" @click="Switch243()">横动</div>
          <div class="btns" @click="Switch244()">电机</div>
        </div>
        <div class="deviceInfo1">
          <table>
            <tr class="contentInfoss">
            ...
            <tr class="contentInfoss" v-for="x in datas4" :key="x.id">
              <td>{{x.name1}}</td>
...
export default {
  ...
  data () {
    return {
      ...
      titleName2: '卡头2电机',
      datass: [
        { name1: '电流(A)', name1Value: 53.01, name2: '电流(A)', name2Value: 0 },
        { name1: '电压(V)', name1Value: 3148, name2: '电压(V)', name2Value: 0 },
        { name1: '温度(℃)', name1Value: 3148, name2: '温度(℃)', name2Value: 0 },
