      ...
      <div class="deviceInfo1">
        <table>
          <tr class="contentInfoss">
            <th class="titles">卷绕机L8#01<br/>基础信息-摩擦辊</th>    <!--标题换行-->
          </tr>
          <tr class="contentInfoss">
            <td>纺丝产线</td>
            <td>纺丝位号</td>
    ...
    <div class="centerBar">
      <div class="headerInfo">
        <div class="titleIcon">
          ...
          <div @click="Switch120()">设备的选择</div>
        </div>
        <div class="titles">Map OverView</div>
        <div>实时动态</div>
      </div>
      <div class="deviceImg">
        <img src="../../assets/img/mocagunimg.jpg" alt="设备">
      </div>
      <div class="footerInfo"><!--
        ...
        <div class="topBar topBar3" >
          ...
          <div class="btns" @click="Switch121()">卡头</div>
          <div class="btns" @click="Switch122()">摩擦辊</div>
          <div class="btns" @click="Switch123()">横动</div>
          <div class="btns" @click="Switch124()">电机</div>
        </div>
        <div class="deviceInfo1">
          <table>
            <tr class="contentInfoss">
            ...
            <tr class="contentInfoss" v-for="x in datas2" :key="x.id">
              <td>{{x.name1}}</td>
              <td style="border: double cadetblue">{{x.name1Value}}</td>
              <td>{{x.name2}}</td>
