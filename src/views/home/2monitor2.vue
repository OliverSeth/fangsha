      ...
      <div class="deviceInfo1">
        <table>
          <tr class="contentInfoss">
            <th class="titles">卷绕机L8#02<br/>基础信息-摩擦辊</th>   <!--标题换行-->
          </tr>
          <tr class="contentInfoss">
            <td>纺丝产线</td>
            <td>纺丝位号</td>
    ...
    <div class="centerBar">
      <div class="headerInfo">
        <div class="titleIcon">
          ...
          <div @click="Switch220()">设备的选择</div>
        </div>
        <div class="titles">Map OverView</div>
        <div>实时动态</div>
      </div>
      <div class="deviceImg">
        <img src="../../assets/img/mocagun2_done.jpg" alt="设备">
      </div>
      <div class="footerInfo"><!--
        ...
        <div class="topBar topBar3" >
          ...
          <div class="btns" @click="Switch221()">卡头</div>
          <div class="btns" @click="Switch222()">摩擦辊</div>
          <div class="btns" @click="Switch223()">横动</div>
          <div class="btns" @click="Switch224()">电机</div>
        </div>
        <div class="deviceInfo1">
          <table>
            <tr class="contentInfoss">
            ...
            <tr class="contentInfoss" v-for="x in datas2" :key="x.id">
              <td>{{x.name1}}</td>
              <td style="border: double lightskyblue">{{x.name1Value}}</td>
              <td>{{x.name2}}</td>
              <td style="border: double lightskyblue">{{x.name2Value}}</td>
            </tr>
          </table>
        </div>
      </div>
...
export default {
  ...
  data () {
    return {
      ...
      titleName2: '摩擦辊外侧',
      datass: [
        { name1: '频率(Hz)', name1Value: 53.01, name2: '频率(Hz)', name2Value: 0 },
        { name1: '转速(rpm)', name1Value: 3148, name2: '转速(rpm)', name2Value: 0 },
      ...
      datas1: [
        { name1: '卡头1频率(Hz)', name1Value: 100.01, name2: '卡头2频率(Hz)', name2Value: 100.01 },
        { name1: '卡头1转速(rpm)', name1Value: 3148, name2: '卡头1转速(rpm)', name2Value: 0 },
        { name1: '异常对象', name1Value: '滚动显示', name2: '异常对象', name2Value: '滚动显示' },
        { name1: '异常位置', name1Value: '滚动显示', name2: '异常位置', name2Value: '滚动显示' }
      ],
      datas2: [
        { name1: '频率(Hz)', name1Value: 100.01, name2: '卡头2频率(Hz)', name2Value: 100.01 },
        { name1: '转速(rpm)', name1Value: 6233, name2: '卡头1转速(rpm)', name2Value: 6233 },
        { name1: '异常对象', name1Value: '滚动显示', name2: '异常对象', name2Value: '滚动显示' },
        { name1: '异常位置', name1Value: '滚动显示', name2: '异常位置', name2Value: '滚动显示' }
      ],
      datas3: [
  ...
  methods: {
    ...
    Switch222 () {
      this.$router.push('2monitor2')
    },
    Switch223 () {
      this.$router.push('2monitor3')
    },
    Switch224 () {
      this.$router.push('2monitor4')
    }
    /* eslint-enable */
  },
  mounted () {
    ...
    setInterval(function () {
      ...
      $.get("http://localhost:5000/load", function (data, status) {
        // console.log(data);
        let data_2 = [];
