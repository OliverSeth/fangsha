      ...
      <div class="deviceInfo1">
        <table>
          <tr class="contentInfoss">
            <th class="titles">卷绕机L8#01<br/>基础信息-电机</th>    <!--标题换行-->
          </tr>
          <tr class="contentInfoss">
            <td>纺丝产线</td>
            <td>纺丝位号</td>
    ...
    <div class="centerBar">
      <div class="headerInfo">
        <div class="titleIcon">
          ...
          <div @click="Switch140()">设备的选择</div>
        </div>
        <div class="titles">Map OverView</div>
        <div>实时动态</div>
      </div>
      <div class="deviceImg">
        <img src="../../assets/img/dianjiimg.jpg" alt="设备">
      </div>
      <div class="footerInfo"><!--
        ...
        <div class="topBar topBar3" >
          ...
          <div class="btns" @click="Switch141()">卡头</div>
          <div class="btns" @click="Switch142()">摩擦辊</div>
          <div class="btns" @click="Switch143()">横动</div>
          <div class="btns" @click="Switch144()">电机</div>
        </div>
        <div class="deviceInfo1">
          <table>
            <tr class="contentInfoss">
