      ...
      <div class="deviceInfo1">
        <table>
          <tr class="contentInfoss">
            <th class="titles">卷绕机L8#02<br/>基础信息-横动</th>   <!--标题换行-->
          </tr>
          <tr class="contentInfoss">
            <td>纺丝产线</td>
            <td>纺丝位号</td>
    ...
    <div class="centerBar">
      <div class="headerInfo">
        <div class="titleIcon">
          ...
          <div @click="Switch230()">设备的选择</div>
        </div>
        <div class="titles">Map OverView</div>
        <div>实时动态</div>
      </div>
      <div class="deviceImg">
        <img src="../../assets/img/hengdong2_done.jpg" alt="设备">
      </div>
      <div class="footerInfo"><!--
        ...
        <div class="topBar topBar3" >
          ...
          <div class="btns" @click="Switch231()">卡头</div>
          <div class="btns" @click="Switch232()">摩擦辊</div>
          <div class="btns" @click="Switch233()">横动</div>
          <div class="btns" @click="Switch234()">电机</div>
        </div>
        <div class="deviceInfo1">
          <table>
            <tr class="contentInfoss">
            ...
            <tr class="contentInfoss" v-for="x in datas3" :key="x.id">
              <td>{{x.name1}}</td>
...
export default {
  ...
  data () {
    return {
      ...
      titleName2: '气缸',
      datass: [
        { name1: '主动电机频率(Hz)', name1Value: 53.01, name2: '气缸1压强', name2Value: 0 },
        { name1: '同步带线速度(rpm)', name1Value: 3148, name2: '气缸2压强', name2Value: 0 },
